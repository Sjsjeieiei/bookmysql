...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* com.book.*.service.*.*(..)) or "
			+ "execution(* com.book.*.dao.*.*(..))")
	...
	@After("execution(* com.book.*.service.*.*(..)) or "
			+ "execution(* com.book.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* com.book.*.service.*.*(..)) or "
			+ "execution(* com.book.*.dao.*.*(..))")
