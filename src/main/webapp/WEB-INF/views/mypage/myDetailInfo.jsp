			...
			<div class="ps-4">
				...
				<div class="table-responsive mt-4">
					<form name="frm_mod_member">
							...
							<table class="table border-top mb-0 small fw-light">
								...
								<tr>
									...
									<td class="px-4">
										...
										</div> <!-- 주소 --> <input type="text" id="member_address"
										class="form-control rounded-0 mb-2" placeholder="주소"
										name="member_address" size="50"
										value="${memberInfo.member_address }"> <!-- 상세주소 --> <input
						...
						<!-- 수정 -->
						<button type="button" onclick="fn_modify_member_info()" class="btn btn-lg border-main rounded-0 w-100 d-block fw-bold p-2 lh-lg mt-0 mb-2 fs-6">수정하기</button>
