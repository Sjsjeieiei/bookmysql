...
<!-- count 값 표시 -->
		<div
			...
			<div
				...
				style="width: 150px">
				<p class="w-100 mb-0 fs-3">MY북숍</p>
			</div>
			<div
			...
			<div
				...
				style="width: 150px">
				<p class="w-100 mb-2 small">북숍머니</p>
				<p class="w-100 mb-0">
				
				<!-- 소팡머니 count -->
					<span class="fw-light me-2 lh-1" style="font-size: 2.2rem;">
					<fmt:formatNumber value="${bookshop_money}" pattern="#,###" /></span>원
				<!-- 소팡머니 count -->
            ...
            style="width: 150px;">
            <p class="fw-bold text-black mb-2">MY북숍</p>
