				...
				<c:choose>
					...
					<a href="${contextPath}/cart/myCartList.do"
							...
							<a href="${contextPath}/admin/goods/adminGoodsMain.do"
								class="text-decoration-none samll btn btn-outline-secondary btn-sm p-0 px-2 rounded-0 bg-white">북숍관리
					...
					<div class="btn-group m-0" role="group">
						...
						<ul class="dropdown-menu rounded-0 shadow border-0 px-2 py-3"
							...
							<li><a class="dropdown-item small"
								href="${contextPath}/goods/menuGoods.do?menuGoods=문학">문학</a></li>
							<li><a class="dropdown-item small"
								href="${contextPath}/goods/menuGoods.do?menuGoods=it">it</a></li>
							<li><a class="dropdown-item small"
								href="${contextPath}/goods/menuGoods.do?menuGoods=만화">만화</a></li>
							<li><a class="dropdown-item small"
								href="${contextPath}/goods/menuGoods.do?menuGoods=웹툰">웹툰</a></li>
						</ul>
					</div>

					<div class="logo d-flex align-items-center px-4">
						<a href="${contextPath}/main/main.do"> <img
							src="${contextPath}/resources/img/Main.jpg" width="150"
							class="p-2">
						</a>
					</div>
