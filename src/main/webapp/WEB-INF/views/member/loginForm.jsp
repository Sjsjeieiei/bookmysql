...
<form action="${contextPath}/member/login.do" method="post" id="loginForm">
    ...
    <button type="button" onClick="loginSopang()" class="btn btn-main rounded-0 w-100 d-block fw-bold p-2 lh-lg mb-3">
        로그인
    </button>

    <a class="btn border-main rounded-0 w-100 d-block fw-bold p-2 lh-lg mb-3" href="${contextPath}/member/memberForm.do">
        회원가입
    </a>
